...
import static root.util.TenantUtil.createSchemaName;
...
public class TenantProvisioningSchemaInitializr {
    ...
    private static final String LIQUIBASE_MASTER_PATH = "db/changelog/db.changelog-master.yaml";

    private final DataSource dataSource;

    public void initializeSchemaForTenant(String tenantId) {
        validateTenantId(tenantId);
        String schemaName = createSchemaName(tenantId);
